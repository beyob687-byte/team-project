...
const USER_IDS = {
  ...
  newstudent: "d3d3d3d3-1111-4111-1111-111111111111",
  workiye: "d4d4d4d4-1111-4111-1111-111111111111",
  gizem: "d5d5d5d5-1111-4111-1111-111111111111",
  dereje: "d6d6d6d6-1111-4111-1111-111111111111",
  addis: "d7d7d7d7-1111-4111-1111-111111111111",
  meskerem: "d8d8d8d8-1111-4111-1111-111111111111",
  tesfaye: "d9d9d9d9-1111-4111-1111-111111111111",
  tadesse: "e0e0e0e0-1111-4111-1111-111111111111",
  lemlem: "e1e1e1e0-1111-4111-1111-111111111111",
  ketut: "e2e2e2e0-1111-4111-1111-111111111111",
};
...
const CLUB_IDS = {
  ...
  medicine: "e6e6e6e6-1111-4111-1111-111111111111",
  law: "e7e7e7e7-1111-4111-1111-111111111111",
  music: "e8e8e8e8-1111-4111-1111-111111111111",
  photography: "e9e9e9e9-1111-4111-1111-111111111111",
  entrepreneurship: "ea10a10a-1111-4111-1111-111111111111",
};

const POST_IDS = {
  cultural: "81111111-1111-4111-8111-111111111111",
  cultural2: "81111112-1111-4111-8111-111111111111",
  cultural3: "81111113-1111-4111-8111-111111111111",
  tech_promo: "82222222-2222-4222-8222-222222222222",
  tech_announcement: "82222223-2222-4222-8222-222222222223",
  tech_workshop: "82222224-2222-4222-8222-222222222224",
  engineering: "83333333-3333-4333-8333-333333333333",
  engineering2: "83333334-3333-4333-8333-333333333334",
  debating: "84444444-4444-4444-8444-444444444444",
  debating2: "84444445-4444-4444-8444-444444444445",
  community: "85555555-5555-4555-8555-555555555555",
  community2: "85555556-5555-4555-8555-555555555556",
  tech_poll: "86666666-6666-4666-8666-666666666666",
  medicine: "87777777-7777-4777-8777-777777777777",
  medicine2: "87777778-7777-4777-8777-777777777778",
  law: "88888888-8888-4888-8888-888888888888",
  music: "89999999-9999-4999-8999-999999999999",
  photography: "8aaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa",
  entrepreneur: "8bbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb",
};
cultural_festival: "f1f1f1f2-1111-4111-1111-111111111111",
  hackathon: "f2f2f2f2-1111-4111-1111-111111111111",
  hackathon2: "f2f2f2f3-1111-4111-1111-111111111111",
  engineering_expo: "f3f3f3f3-1111-4111-1111-111111111111",
  engineering_workshop: "f3f3f3f4-1111-4111-1111-111111111111",
  debate_workshop: "f4f4f4f4-1111-4111-1111-111111111111",
  debate_competition: "f4f4f4f5-1111-4111-1111-111111111111",
  community_cleanup: "f5f5f5f5-1111-4111-1111-111111111111",
  community_service: "f5f5f5f6-1111-4111-1111-111111111111",
  guest_lecture: "f6f6f6f6-1111-4111-1111-111111111111",
  medical_seminar: "f7f7f7f7-1111-4111-1111-111111111111",
  water_system: "c4444444-4444-4444-8444-444444444444",
  health_app: "c5555555-5555-4555-8555-555555555555",
  legal_ai: "c6666666-6666-4666-8666-666666666666",
  music_streaming: "c7777777-7777-4777-8777-777777777777",
  photo_gallery: "c8888888-8888-4888-8888-888888888888",
  startup_platform: "c9999999-9999-4999-8999-999999999999",
  edu_platform: "caaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa",
  law_forum: "f8f8f8f8-1111-4111-1111-111111111111",
  music_concert: "f9f9f9f9-1111-4111-1111-111111111111",
  photo_exhibition: "fafafaff-aaaa-4aaa-ffff-aaaaaaaaaaaa",
  startup_pitch: "fbfbfbfb-bbbb-4bbb-ffff-bbbbbbbbbbbb
...
exports.seed = async function (knex) {
  ...
  const users = [
    ...
    {
      id: USER_IDS.newstudent,
      university_id: UNIVERSITY_ID,
      sso_id: "aau-021",
      email: "newstudent@aau.edu.et",
      first_name: "Abenezer",
      last_name: "Yemeneh",
      student_id: "UGR/01555/14",
      user_type: "student",
      major: "Computer Science",
      department: "Computer Science",
      enrollment_status: "active",
      interests: ["web design", "gaming", "startup"],
      notification_preferences: { email: true, in_app: true, digest: "weekly" },
      created_at: new Date("2024-01-15"),
      last_login: new Date("2025-05-12"),
      password_hash: await bcrypt.hash("StrongPass1", 12),
    },
    {
      id: USER_IDS.workiye,
      university_id: UNIVERSITY_ID,
      sso_id: "aau-022",
      email: "workiye.dagne@aau.edu.et",
      first_name: "Workiye",
      last_name: "Dagne",
      student_id: "UGR/01666/13",
      user_type: "student",
      major: "Medicine",
      department: "School of Medicine",
      enrollment_status: "active",
      interests: ["research", "cardiology", "sports"],
      notification_preferences: { email: true, in_app: true, digest: "weekly" },
    ...
    },
    {
      ...
      university_id: UNIVERSITY_ID,
      sso_id: "aau-023",
      email: "gizem.kidane@aau.edu.et",
      first_name: "Gizem",
      last_name: "Kidane",
      student_id: "UGR/01777/12",
      user_type: "student",
      major: "Law",
      department: "School of Law",
      enrollment_status: "active",
      interests: ["constitutional law", "human rights", "photography"],
      notification_preferences: { email: true, in_app: true, digest: "daily" },
    ...
    },
    {
      ...
      university_id: UNIVERSITY_ID,
      sso_id: "aau-024",
      email: "dereje.assefa@aau.edu.et",
      first_name: "Dereje",
      last_name: "Assefa",
      student_id: "UGR/01888/14",
      user_type: "student",
      major: "Business Administration",
      department: "Business & Management",
      enrollment_status: "active",
      interests: ["entrepreneurship", "finance", "public speaking"],
      notification_preferences: { email: true, in_app: true, digest: "weekly" },
    ...
    },
    {
      ...
      university_id: UNIVERSITY_ID,
      sso_id: "aau-025",
      email: "addis.zelalem@aau.edu.et",
      first_name: "Addis",
      last_name: "Zelalem",
      student_id: "UGR/01999/13",
      user_type: "student",
      major: "Electrical Engineering",
      department: "Electrical Engineering",
      enrollment_status: "active",
      interests: ["power systems", "renewable energy", "robotics"],
      notification_preferences: { email: true, in_app: true, digest: "weekly" },
      created_at: new Date("2023-10-04"),
      last_login: new Date("2025-05-12"),
    },
    {
      id: USER_IDS.meskerem,
      university_id: UNIVERSITY_ID,
      sso_id: "aau-026",
      email: "meskerem.baysa@aau.edu.et",
      first_name: "Meskerem",
      last_name: "Baysa",
      student_id: "UGR/02000/14",
      user_type: "student",
      major: "Music",
      department: "Arts & Design",
      enrollment_status: "active",
      interests: ["traditional music", "composition", "performance"],
      notification_preferences: { email: true, in_app: true, digest: "weekly" },
    ...
    },
    {
      ...
      university_id: UNIVERSITY_ID,
      sso_id: "aau-027",
      email: "tesfaye.solomon@aau.edu.et",
      first_name: "Tesfaye",
      last_name: "Solomon",
      student_id: "UGR/02111/12",
      user_type: "student",
      major: "Photography",
      department: "Arts & Design",
      enrollment_status: "active",
    ...
    },
    {
      ...
      university_id: UNIVERSITY_ID,
      sso_id: "aau-028",
      email: "tadesse.muluken@aau.edu.et",
      first_name: "Tadesse",
      last_name: "Muluken",
      student_id: "UGR/02222/13",
      user_type: "student",
      major: "Business Administration",
      department: "Business & Management",
      enrollment_status: "active",
      interests: ["startups", "marketing", "networking"],
      notification_preferences: { email: true, in_app: true, digest: "weekly" },
    ...
    },
    {
      ...
      university_id: UNIVERSITY_ID,
      sso_id: "aau-029",
      email: "lemlem.getnet@aau.edu.et",
      first_name: "Lemlem",
      last_name: "Getnet",
      student_id: "UGR/02333/14",
      user_type: "student",
      major: "Physics",
      department: "Physics",
      enrollment_status: "active",
      interests: ["quantum mechanics", "research", "teaching"],
      notification_preferences: { email: true, in_app: true, digest: "weekly" },
    ...
    },
    {
      ...
      university_id: UNIVERSITY_ID,
      sso_id: "aau-030",
      email: "ketut.habte@aau.edu.et",
      first_name: "Ketut",
      last_name: "Habte",
      student_id: "UGR/02444/12",
      user_type: "student",
      major: "Environmental Science",
      department: "Environmental Science",
      enrollment_status: "active",
      interests: ["sustainability", "conservation", "policy"],
      notification_preferences: { email: true, in_app: true, digest: "weekly" },
  ...
  const clubs = [
    ...
    {
      id: CLUB_IDS.medicine,
      university_id: UNIVERSITY_ID,
      name: "Medical Students Association",
      short_name: "MSA",
      category: "Academic",
      secondary_categories: ["Health", "Research"],
      mission_statement:
        "Supporting medical students through seminars, research opportunities, and professional development.",
      logo_url: "https://example.com/msa-logo.png",
      contact_email: "medstudents@aau.edu.et",
      social_links: { instagram: "@aau_medstudents" },
      membership_policy: "approval",
      recruiting_status: true,
      status: "active",
      meeting_schedule: {
        day: "Tuesday",
        time: "5:00 PM",
        location: "Medical Building 301",
        frequency: "weekly",
      },
      tags: ["medicine", "research", "healthcare"],
      created_at: new Date("2021-05-10"),
      updated_at: new Date("2024-03-20"),
    },
    {
      id: CLUB_IDS.law,
      university_id: UNIVERSITY_ID,
      name: "Law Students Forum",
      short_name: "LSF",
      category: "Academic",
      secondary_categories: ["Law", "Social Justice"],
      mission_statement:
        "Promoting legal knowledge and social justice through moot courts, seminars, and community outreach.",
      logo_url: "https://example.com/lsf-logo.png",
      contact_email: "lawstudents@aau.edu.et",
      membership_policy: "open",
      recruiting_status: true,
      status: "active",
      meeting_schedule: {
        day: "Friday",
        time: "4:00 PM",
        location: "Law Building 102",
        frequency: "weekly",
      },
      tags: ["law", "justice", "moot court"],
      created_at: new Date("2020-08-15"),
    ...
    },
    {
      ...
      short_name: "ME",
      category: "Cultural",
      secondary_categories: ["Arts", "Performance"],
      mission_statement:
        "Celebrating diverse musical traditions and fostering artistic expression through performances and collaborations.",
      logo_url: "https://example.com/me-logo.png",
      contact_email: "musicensemble@aau.edu.et",
      social_links: { instagram: "@aau_musicensemble" },
      membership_policy: "audition",
      recruiting_status: true,
      status: "active",
      meeting_schedule: {
        day: "Wednesday",
      ...
      tags: ["music", "performance", "composition"],
      created_at: new Date("2021-02-01"),
      updated_at: new Date("2024-01-30"),
    },
    {
      id: CLUB_IDS.photography,
      university_id: UNIVERSITY_ID,
      name: "Photography & Film Club",
      short_name: "PFC",
      category: "Cultural",
      secondary_categories: ["Arts", "Media"],
      mission_statement:
        "Documenting campus life and exploring visual storytelling through photography and videography.",
      logo_url: "https://example.com/pfc-logo.png",
      contact_email: "photofilm@aau.edu.et",
      social_links: { instagram: "@aau_photofilm" },
      membership_policy: "open",
      recruiting_status: true,
      status: "active",
      meeting_schedule: {
        day: "Saturday",
        time: "3:00 PM",
        location: "Student Center Lab",
        frequency: "biweekly",
      },
      tags: ["photography", "videography", "creative"],
      created_at: new Date("2021-09-20"),
      updated_at: new Date("2024-04-10"),
    },
    {
      id: CLUB_IDS.entrepreneurship,
      university_id: UNIVERSITY_ID,
      ...
      mission_statement:
        "Empowering students to turn ideas into ventures through incubation, mentoring, and networking events.",
      logo_url: "https://example.com/eih-logo.png",
      contact_email: "startup@aau.edu.et",
      social_links: { linkedin: "aau-startup-hub" },
      membership_policy: "open",
      recruiting_status: true,
      status: "active",
      meeting_schedule: {
