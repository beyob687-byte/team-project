  ...
  return (
    <div className="min-h-screen bg-deep flex flex-col items-center justify-center p-4 selection:bg-primary/30">
      ...
      <Link to="/" className="flex items-center gap-2 mb-8 z-10 group">
        <div className="w-10 h-10 rounded-md bg-primary flex items-center justify-center text-deep font-display font-bold text-2xl group-hover:shadow-glow transition-all duration-300">
          U
        </div>
      ...
      <p className="text-text-2/60 text-xs mt-8 text-center z-10">
        By logging in, you agree to your University's Terms of Service and
        Privacy Policy.
      </p>
    </div>
  );
