...
import RequireClubRole from "./components/layout/RequireClubRole";
...
const NotificationsPage = React.lazy(
  () => import("./components/shared/NotificationsPage"),
);

// Officer Pages
const ManageDashboard = React.lazy(
  () => import("./pages/officer/ManageDashboard"),
);
...
const AdminRegistrationReview = React.lazy(
  () => import("./pages/admin/ClubRegistrationReview"),
);
          ...
          <Route element={<RequireAuth />}>
            <Route element={<RequireRole role="University Admin" />}>
              ...
              >
                ...
                <Route
                  path="clubs/requests/:requestId"
                  element={<AdminRegistrationReview />}
                />
